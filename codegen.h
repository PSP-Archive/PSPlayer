...
// copy gpr to vfpu_rd (single)
#define mtv(vfpu_rd, gpr) (0x48e00000 | ((gpr) << 16) |  vfpu_rd)
...
#define vfim_s(vfpu_rd,immediate)  (0xdf800000 | ((vfpu_rd) << 16) | ((immediate) & 0xffff))
...
*/
#define vus2i_s(vfpu_rd,vfpu_rs)  (0xd03a0000 | ((vfpu_rs) << 8) | (vfpu_rd))
#define vus2i_p(vfpu_rd,vfpu_rs)  (0xd03a0080 | ((vfpu_rs) << 8) | (vfpu_rd))
...
*/
#define vs2i_s(vfpu_rd,vfpu_rs)  (0xd03b0000 | ((vfpu_rs) << 8) | (vfpu_rd))
#define vs2i_p(vfpu_rd,vfpu_rs)  (0xd03b0080 | ((vfpu_rs) << 8) | (vfpu_rd))
...
|31                                     15 | 14         8 | 7 | 6          0 |
+------------------------------------------+--------------+---+--------------+
|              opcode 0x48e00000           | vfpu_rs[6-0] | 1 | vfpu_rd[6-0] |
+------------------------------------------+--------------+---+--------------+

    mtv %rt, %vfpu_rd    ; load from gpr(rt) to vfpu register. single.

        %rt:	GPR register
        %vfpu_rd:	VFPU Vector Destination Register (single)
*/
//#define mtv(rt,vfpu_rd)  (0x48e00000 | ((vfpu_rd)) | (rt))
